...
async def inbound_sms(
    ...
    message = Body.strip()
    if not message:
        return sms_response("Hi! Text us your order and we'll get it sorted. Text MENU for the menu.")

    # Quick commands
    if message.upper() == "MENU":
        return sms_response(
            "Cranny Boys Pizza Menu:\n"
            "🍕 Traditional from $12.90 (Small) to $26.90 (Jumbo)\n"
            "🍕 Gourmet from $16.90 (Small) to $30.90 (Jumbo)\n"
            "🍝 Pasta $15.90 (Spaghetti/Penne/Fettuccine/Rigatoni)\n"
            "🍗 Parma $20.90 | Wings $13.90\n"
            "Sizes: Small, Medium, Large, Family, Jumbo\n\n"
            "Just text your order! e.g. 'Large Hawaiian pizza'"
        )
