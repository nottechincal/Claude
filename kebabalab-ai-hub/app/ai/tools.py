"""
Claude AI tool definitions for the ordering system.
...
ORDERING_TOOLS = [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "query": {
                    "type": "string",
                    "description": "What the customer said they want (e.g. 'large chicken kebab', 'HSP', 'chips')",
                },
            },
            "required": ["query"],
        },
    ...
    {
        "name": "add_to_cart",
        "description": "Add one or more items to the customer's cart. Handles natural language descriptions — call search_menu first if unsure about the exact item.",
        "input_schema": {
            "type": "object",
            "properties": {
                "items": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "size": {"type": "string", "description": "small or large (if applicable)"},
                            "protein": {"type": "string", "description": "lamb, chicken, mixed, falafel (for kebabs/HSP)"},
                            "salads": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "List of salad choices",
                            },
                            "sauces": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "List of sauce choices",
                            },
                            "extras": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "Extra items (cheese, jalapeños, etc)",
                            },
    ...
    {
        "name": "edit_cart_item",
        "description": "Edit any property of an item already in the cart (size, protein, salads, sauces, quantity, etc). Use the item index from view_cart.",
        "input_schema": {
            "type": "object",
            "properties": {
                "item_index": {
                ...
                "changes": {
                    ...
                    "properties": {
                        "size": {"type": "string"},
                        "protein": {"type": "string"},
                        "salads": {"type": "array", "items": {"type": "string"}},
